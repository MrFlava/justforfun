...
from src.menus.admin.admmenu import AdminMenu
from src.menus.start.startmenu import StartMenu
...
def stop(update, context):
    ...
    if context.user_data:
        ...
        DBSession.add(user)
        DBSession.commit()
        context.bot.send_message(chat_id=user.chat_id, text= ("Вы удалены из этого бота"))
...
def main():
    ...
    updater = BotmanUpdater(bot=bot, use_context=True)
