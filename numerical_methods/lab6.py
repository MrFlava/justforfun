...
for l in range(iterations):
    ...
    x1 = (arrB[0] - arrA[0][1] * x2_0 - arrA[0][2] * x3_0) / arrA[0][0]
    x2 = (arrB[1] - arrA[1][0] * x2_0 - arrA[1][2] * x3_0) / arrA[1][1]
    x3 = (arrB[2] - arrA[2][0] * x2_0 - arrA[2][2] * x3_0) / arrA[2][2]
    abs_1 = math.fabs(x1_0 - x1)
    abs_2 = math.fabs(x2_0 - x2)
    abs_3 = math.fabs(x3_0 - x3)
    while(max(abs_1,abs_2,abs_3)) > epsi:
            print(x1, x2, x3)
            break
